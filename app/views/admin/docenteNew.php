<div class="align-items-md-stretch mt-5">
    <div class="card">
        <div class="card-header">
            <h1 class="card-title">Nuevo docente</h1>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="col-md-4 p-2">
                ...
                <?= form_dropdown('document_type', $document_type, set_value('document_type'), 'class="form-control" id="document_type"'); ?>
            </div>
            <div class="col-md-4 p-2">
            ...
            <div class="col-md-2 p-2">
                ...
                <?= form_dropdown('gender', $gender, set_value('gender'), 'class="form-control" id="gender"'); ?>
            </div>
            <div class="col-md-2 p-2">
            ...
            <div class="col-md-2 p-2">
                ...
                <?= form_dropdown('graduated', $condDocente, set_value('graduated'), 'class="form-control" id="graduated"'); ?>
            </div>
